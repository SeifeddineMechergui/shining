      ...
      <div className="mx-auto space-y-4">
          ...
          {activeTab === 2 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                us at support@lamode.com with your order number and a
          ...
          {activeTab === 4 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                support@lamode.com, or by calling us at (555) 123-4567
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          {activeTab === 6 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                Currently, we only offer shipping within the Tunisia a.
              </p>
            </div>
          )}
        </div>
